...
export function EpisodeTitleInfo({ animeTitle, episodeNumber, episodeTitle, duration }: Props) {
    return (
        <View className="p-5">
            ...
            {episodeTitle ? (
                <Text className='font-normal text-xs text-foreground mt-1' numberOfLines={1}>
                    {episodeTitle}
                </Text>
            ) : null}
        </View>
