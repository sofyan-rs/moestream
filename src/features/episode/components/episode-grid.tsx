...
export function EpisodeGrid({ episodes, totalEps, currentEpisodeNumber, onSelect, accent, surfaceColor, isDark }: Props) {
    return (
        <View className="p-5">
            <View
            ...
            >
                ...
                <Text className='font-normal text-xs text-foreground'>{totalEps} eps</Text>
            </View>
                    ...
                    {episodes.map(ep => {
                        ...
                        return (
                            ...
                            >
                                <Text className={
                                    cn('text-base',
                                        isActive ? 'text-white font-semibold' : 'text-foreground font-normal',
                                    )
                                }>
                                    {ep.number}
                                </Text>
